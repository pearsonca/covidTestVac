...
Using \eref{delppd}, we find that regions with relatively high seroprevalence could substantially expand vaccine coverage using a pre-vaccination antibody testing program. Rearranging \eref{delppd} and considering a high specificity (99\%) test, only moderate seroprevalence and sensitivity are required to observe gains: 
